...
module.exports = function(game, opts) {
    console.log("loaded vendored outline plugin")
...
function OutlinePlugin(game, opts) {
  ...
  this.selectAdjacent = opts.selectAdjacent !== undefined ? opts.selectAdjacent : false;
...
OutlinePlugin.prototype.tick = function() {
  ...
  var newTarget = this.selectAdjacent ? hit.adjacent : hit.voxel;
  if (!this.currentTarget ||
      newTarget[0] !== this.currentTarget[0] ||
      newTarget[1] !== this.currentTarget[1] ||
      newTarget[2] !== this.currentTarget[2]) {

    // translate to adjacent position
    mat4.identity(this.modelMatrix);
    mat4.translate(this.modelMatrix, this.modelMatrix, newTarget);
    ...
    this.currentTarget = newTarget.slice();
...
OutlinePlugin.prototype.render = function() {
  if (this.showOutline && this.currentTarget) {
    ...
    this.outlineShader.attributes.color.location = 1;
